...
profileRouter.delete('/profile/:id', verifyAuth, validator.verifyAccess, ProfileController.deleteOneProfile);
profileRouter.patch('/profile/:id', verifyAuth, validator.verifyAccess, ProfileController.updateProfile)
